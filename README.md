This repository contains the solution for a test task designed for a Junior .NET Developer role. The project is a Web API built using .NET and connected to an Azure SQL Database.
